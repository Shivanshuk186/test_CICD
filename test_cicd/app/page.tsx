  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-2xl w-full relative z-10">
        {!showWish ? (
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-12 text-center transition-all duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-white/20 text-white font-medium py-3 rounded-lg hover:bg-white/30 transition-all backdrop-blur-sm"
              >
                Continue
              </button>
            </form>
